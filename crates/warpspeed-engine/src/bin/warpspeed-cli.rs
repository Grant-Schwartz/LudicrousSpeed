...
use warpspeed_engine::{
    CalcMode, CalcResult, CalculationStrategy, ChangedCell, FallbackReason, WarpSpeedEngine,
    WorkbookSnapshot,
};
...
fn print_data_table_diagnostics(diagnostics: &[warpspeed_engine::DataTableDiagnostic]) {
...
fn data_table_status_label(status: warpspeed_engine::DataTableEvaluationStatus) -> &'static str {
    match status {
        warpspeed_engine::DataTableEvaluationStatus::None => "none",
        warpspeed_engine::DataTableEvaluationStatus::MetadataOnly => "metadata_only",
        warpspeed_engine::DataTableEvaluationStatus::Reused => "reused",
        warpspeed_engine::DataTableEvaluationStatus::Validated => "validated",
        warpspeed_engine::DataTableEvaluationStatus::Mismatch => "mismatch",
        warpspeed_engine::DataTableEvaluationStatus::Unsupported => "unsupported",
        warpspeed_engine::DataTableEvaluationStatus::Partial => "partial",
    }
}
