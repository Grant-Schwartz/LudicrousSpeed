...
const workbookPath = path.join(outputDir, "WarpSpeed_Complex_LBO_Test_Model.xlsx");
...
// Cover
title(sheets.cover, "WarpSpeed Complex LBO Recalculation Test Model");
setValues(sheets.cover, "A3:B12", [
  ["Purpose", "Formula-heavy synthetic LBO workbook for testing WarpSpeed / IronCalc full-workbook calculation."],
...
setValues(sheets.sources, "A4:E12", [
  ["All financial values", "Synthetic", "$mm", "Generated by WarpSpeed fixture builder", "Not company-specific; designed for calculation engine regression."],
  ...
  ["Use case", "WarpSpeed regression", "N/A", "Internal test model", "Large enough to profile formula coverage and sensitivity recalc paths."],
]);
