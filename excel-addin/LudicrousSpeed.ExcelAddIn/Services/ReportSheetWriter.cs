...
namespace LudicrousSpeed.ExcelAddIn.Services
{
    internal sealed class ReportSheetWriter
    {
        ...
        public void Write(EngineResponse response, HostRunMetrics hostMetrics, bool enabled, bool detailed)
        {
            ...
            {
                new KeyValuePair<string, object?>("LudicrousSpeed Report", DateTime.Now.ToString("u")),
            };
            ...
            Add("LudicrousSpeed end-to-end ms", hostMetrics.LudicrousEndToEndMs);
            ...
            Add("Rust total ms", benchmark.TotalLudicrousMs);
